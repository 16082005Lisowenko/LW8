...
def test_title_cannot_be_none(validator):
    assert validator.is_title_valid(None) == False


def test_title_cannot_be_empty(validator):
    assert validator.is_title_valid("") == False


def test_title_cannot_be_whitespace(validator):
    assert validator.is_title_valid("   ") == False


def test_due_date_cannot_be_none(validator):
